    ...
    RSpec.describe Condition, type: :request do
      describe ".resolve" do
        it "gets a condition" do
          ...
          keys = %i[id userId name medications doctors healthEvents]
          doctor_keys = %i[name phone address category]
          health_event_keys = %i[date note category]
          medication_keys = %i[name datePrescribed dosage frequency prescribedBy]
